...
Canvas lecture slides and Notifications function. LINK: https://connex.csc.uvic.ca/access/content/group/bb9a8803-9024-4dc0-a098-aeff66c17a60/lect17_canvas.pdf
...
//On success, retrieve data for weather
 function searchSuccess2(data, textStatus, jqXHR) {
  ...
  $("#Sun").click(function() {
   ...
   var showDays = function showNumberDays() {
   ...
   */ 
   ...
   function notifyMe() {
     ...
     // Let's check whether notification permissions have already been granted
       ...
       if (temperature < 5)
       {
         var notification = new Notification("The temperture is currently " + temp + " degrees");
       }
       else if (icon === "rain") {
...
//  myDivObj = document.getElementById("containerWeatherDaysId");
  myDivObj = document.getElementById("containerDay")  
  if ( myDivObj ) {
    info.push(myDivObj.textContent); 
   console.log("ddmd"+ info)
  }else{
...
function loadWeatherInfo() {
  var reload = $('<div id="reloadId" class="reload"></div>')
  var arr = [] 
